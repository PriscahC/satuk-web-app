...
const Schoolhome = (props) => {
    const [ActiveTab, setActiveTab] = useState(parseInt(0))
  return (
    <>
        <div className="sh_wrapper">
            ...
            <div className="sh-container 1">
                ...
                {cdata.map((data,index)=>(
                    ...
                    <div className={`sh-tab_heading ${ActiveTab === index ? 'active' : ''}`} onClick={()=>setActiveTab(index)}>
                        <span>{data.course}</span>
                    </div>
                    <div className="sh-tab_content" key={index} onClick={props.fun}>
